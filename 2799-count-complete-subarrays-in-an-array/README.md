<h2><a href="https://leetcode.com/problems/count-complete-subarrays-in-an-array/">2799. Count Complete Subarrays in an Array</a></h2><h3>Medium</h3><hr><div><p>You are given an array <code>nums</code> consisting of <strong>positive</strong> integers.</p>
...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,3,1,2,2]
...
<pre style="position: relative;"><strong>Input:</strong> nums = [5,5,5,5]
