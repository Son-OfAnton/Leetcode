<h2><a href="https://leetcode.com/problems/create-sorted-array-through-instructions/">1649. Create Sorted Array through Instructions</a></h2><h3>Hard</h3><hr><div><p>Given an integer array <code>instructions</code>, you are asked to create a sorted array from the elements in <code>instructions</code>. You start with an empty container <code>nums</code>. For each element from <strong>left to right</strong> in <code>instructions</code>, insert it into <code>nums</code>. The <strong>cost</strong> of each insertion is the <b>minimum</b> of the following:</p>
...
<pre style="position: relative;"><strong>Input:</strong> instructions = [1,5,6,2]
...
The total cost is 0 + 0 + 0 + 1 = 1.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 2:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> instructions = [1,2,3,6,5,4]
...
<pre style="position: relative;"><strong>Input:</strong> instructions = [1,3,3,3,2,4,2,1,2]
