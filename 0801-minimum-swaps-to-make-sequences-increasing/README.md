...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [1,3,5,4], nums2 = [1,2,3,7]
...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [0,3,5,8,9], nums2 = [2,1,4,6,9]
<strong>Output:</strong> 1
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
