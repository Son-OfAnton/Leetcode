...
<pre style="position: relative;"><strong>Input:</strong> n = 4, edges = [[0,1],[1,2],[1,3]], price = [2,2,10,6], trips = [[0,3],[2,1],[2,3]]
...
<pre style="position: relative;"><strong>Input:</strong> n = 2, edges = [[0,1]], price = [2,2], trips = [[0,0]]
